...
class Tyres {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Tyres_Loader $loader Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	 ...
	 *
	 * - Tyres_Loader. Orchestrates the hooks of the plugin.
	 * - Tyres_i18n. Defines internationalization functionality.
	 * - Tyres_Admin. Defines all hooks for the admin area.
	 * - Tyres_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-tyres-loader.php';
		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-tyres-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-tyres-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-tyres-public.php';

		$this->loader = new Tyres_Loader();
	 ...
	 *
	 * @return    Tyres_Loader    Orchestrates the hooks of the plugin.
	 * @since     1.0.0
	 */
